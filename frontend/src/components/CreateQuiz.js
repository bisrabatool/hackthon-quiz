        ...
        <AppBar sx={{ 
          ...
          <Toolbar>
            ...
            <Button autoFocus color="inherit"
             onClick={() => handleSave(`Quiz ${currentQuizIndex !== null ? currentQuizIndex + 1 : quizzes.length + 1}`)}
              sx={{fontWeight:"bold"}}>
              Save
            </Button>
            {currentQuizIndex !== null && (
              <Button color="inherit" onClick={() => handleDelete(currentQuizIndex)} sx={{fontWeight:"bold"}}>
                Delete
              </Button>
            )}
          </Toolbar>
